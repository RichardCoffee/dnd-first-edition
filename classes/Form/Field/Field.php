 ...
 */
abstract class DND_Form_Field_Field {
...
#		}
		...
		if ( empty( $this->placeholder ) ) {
			if ( empty( $this->description ) ) {
				$this->placeholder = ( $this->required ) ? __( 'Required Field', 'dnd-first-edition' ) : '';
			} else {
				$this->placeholder = $this->description . ( ( $this->required ) ? ( ' ' . __( '(required field)', 'dnd-first-edition' ) ) : '' );
			}
		}
		if ( empty( $this->id ) ) {
			$this->id = $this->name;
		...
		if ( $this->required ) {
			if ( empty( $this->title ) ) {
				$this->title = __( 'Required Field', 'dnd-first-edition' );
			} else {
				$this->title .= ' ' . __( '(required field)', 'dnd-first-edition' );
			}
		}
