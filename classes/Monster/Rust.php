<?php
/* Name: Rust Monster
 * Class: DND_Monster_Rust
 * Encounter: {}
 */

class DND_Monster_Rust extends DND_Monster_Monster {
...
#	protected $armor_type   = 11;      // DND_Monster_Trait_Combat
	protected $attacks      = array( 'Claw R' => [ 0, 0, 0 ], 'Claw L' => [ 0, 0, 0 ] );
