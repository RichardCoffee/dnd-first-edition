<?php
/* Name: Brown Bear
 * Class: DND_Monster_Animal_Bear_Brown
 * Encounter: {"CW":{"M":"R","H":"C","F":"C","S":"R"},"TW":{"M":"R","H":"C","F":"C","S":"R"}}
 */

class DND_Monster_Animal_Bear_Brown extends DND_Monster_Monster {
...
#	protected $armor_type   = 11;
	protected $attacks      = array( 'Claw Right' => [ 1, 6, 0 ], 'Claw Left' => [ 1, 6, 0 ], 'Bite' => [ 1, 8, 0 ] );
#	public    $current_hp   = 0;
...
#	protected $xp_value     = array( 0, 0, 0, 0 );
	...
	protected function determine_specials() {
		...
		$this->specials['hugs'] = 'On claw hit of 18+, does bear hug for 2d6 damage';
	}
