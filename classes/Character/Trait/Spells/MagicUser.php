		...
		return array(
			'Cantrip' => array(
				...
				'Smokepuff' => array(
					...
					'page' => 'UA 50',
					'type' => 'Evocation',
					'aoe'  => 'one foot dia. cloud, see spell',
				),
			...
			'First' => array(
				...
				'Alarm' => array(
					...
					'type'     => 'Evocation',
					'range'    => '10 feet',
					'duration' => sprintf( '2d4+%u turns', $level ),
					'aoe'      => sprintf( 'Up to %u sq. ft.', $level * 20 ),
					'comps'    => 'V, S, M',
					'cast'     => '1 round',
					'saving'   => 'None',
				),
				'Armor' => array(
					...
					'cast'      => '1 round',
					'saving'    => 'None',
					'special'   => sprintf( '%u points of damage will dissipate the Armor spell', $level + 8 ),
					'apply'     => 'magicuser_first_armor',
					'post'      => 'magicuser_first_armor_post',
					'condition' => 'this_target_only',
					'filters'   => array(
						array( 'dissipation_hit_points', ( $level + 8 ), 10, 2 ),
					),
					'status' => 'magicuser_armor_status',
				),
				'Burning Hands' => array(
					'page'     => 'PH 65',
					'type'     => 'Alteration',
					...
					'cast'     => '1 segment',
					'saving'   => 'None',
					'special'  => sprintf( 'damage: %u hit points', $level ),
				),
				'Charm Person' => array(
					'page'     => 'PH 66, PH 56',
				...
				'Comprehend Languages' => array( 'page' => 'PH 66', 'type' => 'Alteration', 'cast' => '1 round',
					'duration' => sprintf( '%3.1f turns', $level / 2  ),
				),
				'Dancing Lights' => array(
					'page'     => 'PH 66',
					'type'     => 'Alteration',
				...
				'Detect Magic (M)' => array(
					...
					'cast'     => '1 segment',
					'saving'   => 'None',
					'special'  => sprintf( 'This spell detects the intensity of the magic (dim, faint, moderate, strong, very strong, intense) and there is a %u%% chance that the type (abjuration, alteration, etc.) can be found as well, although if a dual type, the detection percentage applies to both and must be rolled for separately.', $level * 10 ),
				),
				'Feather Fall' => array(
					'page' => 'PH 67',
					'type' => 'Alteration',
					'cast' => '0.1 segments',
					'duration' => sprintf( '%u segments', $level ),
				),
				...
				'Firewater' => array(
					...
					'range'    => '10 feet',
					'duration' => '1 round',
					'aoe'      => sprintf( '%u pints of water', $level ),
					'comps'    => 'V,S,M',
					'cast'     => '1 segment',
					'saving'   => 'None',
				),
				'Friends' => array(
					...
					'range'    => '0',
					'duration' => sprintf( '%u rounds', $level ),
					'aoe'      => sprintf( '%u radius sphere', ( $level * 10 ) + 10 ),
					'comps'    => 'V,S,M',
					'cast'     => '1 segment',
					'saving'   => 'Special',
				...
				'Jump' => array(
					...
					'cast'     => '1 segment',
					'saving'   => 'None',
					'special'  => sprintf( 'Allows %u jumps', ceil( $level / 3 ) ),
				),
				'Light' => array(
					'page'     => 'PH 68, PH 45',
					'type'     => 'Alteration',
				...
				'Magic Missile' => array(
					...
					'special' => sprintf( '%1$ud4+%1$u', intval( ( $level + 1 ) / 2 ) ),
					'apply'   => 'magicuser_first_magic_missile',
					'target'  => 'enemy',
				),
				'Melt' => array(
					'page'     => 'UA 52',
					...
					'range'    => '30 feet',
					'duration' => sprintf( '%u rounds', $level ),
					'aoe'      => sprintf( '%u cubic yards of ice or %u cubic yards of snow', $level, $level * 2 ),
					'comps'    => 'V,S,M',
					'cast'     => '1 segment',
					'saving'   => 'Special',
					'special'  => sprintf( 'Cold creatures: %u points of damage, or half that if ST is successful.', $level * 2 ),
				),
				'Mending' => array(
					'page'     => 'PH 68',
					'type'     => 'Alteration',
				...
				'Message' => array( 'page' => 'PH 68', 'type' => 'Alteration', 'cast' => '1 segment',
					'range'    => sprintf( '%u feet', ( $level * 10 ) + 60 ),
					'duration' => sprintf( '%u segments', $level + 5 ),
				),
				'Mount' => array(
					'page'     => 'UA 52',
					'type'     => 'ConjurationlSummoning',
					'range'    => '10 feet',
					'duration' => sprintf( '%u hours', $level + 2 ),
					'aoe'      => 'One creature',
					'comps'    => 'V, S, M',
					'cast'     => '1 round',
					'saving'   => 'None',
				),
				"Nystul's Magic Aura" => array(
					'page'     => 'PH 68',
					'type'     => 'Illusion/Phantasm',
					'range'    => 'Touch',
					'duration' => sprintf( '%u days', $level ),
					'aoe'      => sprintf( 'single item weighing up to %u lbs', $level * 5 ),
					'comps'    => 'V, S, M',
					'cast'     => '1 round',
					'saving'   => 'Special',
				),
				...
				'Run' => array(
					...
					'cast'     => '1 round',
					'saving'   => 'None',
					'special'  => sprintf( 'Can affect %u individuals', floor( $level / 2 ) + 1 ),
				),
				'Sleep' => array( 'page' => 'PH 69', 'type' => 'Enchantment/Charm', 'cast' => '1 segment',
					'duration' => sprintf( '%u rounds', $level * 5 ),
				),
				...
				"Tenser's Floating Disc" => array(
					'page'     => 'PH 69',
					'type'     => 'Evocation',
					'duration' => sprintf( '%u turns', $level + 3 ),
					'cast'     => '1 segment',
				),
				...
				'Ventriloquism' => array( 'page' => 'PH 70', 'type' => 'Illusion/Phantasm', 'cast' => '1 segment',
					'range'    => sprintf( '%u feet', max( $level * 10, 60 ) ),
					'duration' => sprintf( '%u rounds', $level + 2 ),
				),
			...
			'Second' => array(
				...
				'Bind' =>array(
					...
					'range'    => '30 feet',
					'duration' => sprintf( '%u rounds', $level ),
					'aoe'      => sprintf( '%u feet of 1 inch diameter rope', ( $level * 5 ) + 50 ),
					'comps'    => 'V, S, M',
					'cast'     => '2 segments',
					'saving'   => 'None',
				...
				'Invisibility' => array(
					...
					'cast'     => '2 segments',
					'saving'   => 'None',
					'special'  => 'Creature with 13+ intelligence and 10+ HD/levels may detect creature.',
				),
				'Knock' => array(
					'page'     => 'PH 71',
					'type'     => 'Alteration',
					'range'    => '60 feet',
					'duration' => 'Special',
					'aoe'      => sprintf( '%u square feet', $level * 10 ),
					'comps'    => 'V',
					'cast'     => '1 segment',
					'saving'   => 'None',
				),
				...
				'Levitate' => array( 'page' => 'PH 71', 'type' => 'Alteration', 'cast' => '2 segments',
					'range'    => sprintf( '%u feet', $level * 20 ),
					'duration' => sprintf( '%u turns', $level ),
					'special'  => sprintf( 'Can levitate up to %u pounds', $level * 100 ),
				),
				...
				'Mirror Image' => array(
					...
					'filters'   => array(
						array( 'dnd1e_damage_to_target', 'magicuser_mirror_image_target', 10, 3 ),
						array( 'dnd1e_object_status',    'magicuser_mirror_image_number', 10, 2 ),
					),
					'status' => 'magicuser_mirror_image_status',
					'target' => 'origin',
				),
				...
				'Zephyr' => array( 'page' => 'UA 55', 'type' => 'Evocation', 'cast' => '2 segments',
					'aoe' => sprintf( "10' path, %u' length", $level * 5 ),
				),
			),
			'Third' => array(
				...
				'Item' => array( 'page' => 'UA 55', 'type' => 'Alteration', 'cast' => '3 segments',
					'duration' => sprintf( '%u hours (non-living %u hours)', $level, $level * 4 ),
					'aoe'      => sprintf( '%u cubic feet', $level * 2 ),
				),
				'Lightning Bolt' => array( 'page' => 'PH 75', 'type' => 'Evocation', 'cast' => '3 segments',
					'range'   => sprintf( '%u feet', ( $level + 4 ) * 10 ),
					'aoe'     => 'Single Bolt: 5 ft wide, 80 feet long; Forked Bolt: 10 ft wide, 40 feet long',
					'special' => sprintf( 'damage %ud6', $level ),
					'target'  => 'aoe',
				),
				"Melf's Minute Meteor" => array(
					...
					'range'    => sprintf( '%u feet', $level * 10 ),
					'duration' => sprintf( '%u segments or %u rounds', $level * 2, $level ),
				...
				'Phantasmal Force' => array( 'page' => 'PH 76', 'type' => 'Illusion/Phantasm', 'cast' => '3 segments',
					'range' => sprintf( '%u feet', ( $level * 10 ) + 80 ),
					'aoe'   => sprintf( '%u square inches', $level + 8 ),
				),
				...
				'Sepia Snake Sigil' => array(
					...
					'cast'     => '3 segments',
					'saving'   => 'None',
					'special'  => sprintf( 'Snake attacks a %u HD monster', $level ),
					'apply'    => 'magicuser_third_sepia_snake_sigil',
					'filters'  => array(
						array( 'dnd1e_origin_damage', 'magicuser_sepia_snake_sigil_effect', 10, 3 ),
					),
				),
				'Slow' => array( 'page' => 'PH 76', 'type' => 'Alteration', 'cast' => '3 segments',
					'range'    => sprintf( '%u feet', ( $level * 10 ) + 90 ),
					'duration' => sprintf( '%u rounds', $level + 3 ),
					'aoe'      => sprintf( '40 x 40 foot area, %u creatures', $level ),
				),
				'Suggestion' => array(
					'page'     => 'PH 76',
					'type'     => 'Enchantment/Charm',
					'range'    => '30 feet',
					'duration' => sprintf( '%u turns', ( $level * 6 ) + 6 ),
					'aoe'      => 'One creature',
					'comps'    => 'V, M',
					'cast'     => '3 segments',
					'saving'   => 'Negates',
			...
			'Fourth' => array(
				...
				'Hallucinatory Terrain' => array( 'page' => 'PH 78', 'type' => 'Illusion/Phantasm', 'cast' => '1 turn',
					'range' => sprintf( '%u feet', $level * 20 ),
					'aoe'   => sprintf( ' %1$u x %1$u square area', $level * 10 ),
				),
				'Heat Metal' => array(
					'page'       => 'PH 57',
					'type'       => 'Alteration',
					...
					'range'    => sprintf( '%u feet', $level * 5 ),
					'duration'   => '7 rounds',
					'aoe'        => sprintf( '%u man-sized creatures', intval( $level / 2 ) ),
					'comps'      => 'V,S,M',
					'cast'       => '4 segments',
					'saving'     => 'None',
					'special'    => sprintf( 'Max %u ) Mild: 1d6 (2,6);  Severe: 2d6 (3,4,5)', intval( $level / 2 ) ),
				...
				"Leomund's Secure Shelter" => array( 'page' => 'UA 57', 'type' => 'Alteration,Enchantment', 'cast' => '4 turns',
					'duration' => sprintf( '%u hours', $level ),
					'aoe'      => sprintf( '%u square feet', $level * 30 ),
				),
				'Plant Growth' => array( 'page' => 'PH 79,58', 'type' => 'Alteration', 'cast' => '4 segments',
					'range' => sprintf( '%u feet', $level * 10 ),
					'aoe'   => sprintf( ' %1$u x %1$u square feet area', $level * 10 ),
				),
				...
				'Polymorph Other' => array( 'page' => 'PH 79', 'type' => 'Alteration', 'cast' => '3 segments',
					'duration' => sprintf( '%u turns', $level * 2 ),
				),
				...
				'Wall of Ice' => array( 'page' => 'PH 79', 'type' => 'Evocation', 'cast' => '4 segments',
					'range'    => sprintf( '%u feet', $level * 10 ),
					'duration' => sprintf( '%u turns', $level ),
					'aoe'      => sprintf( '%u inches thick with %u square feet area', $level, $level * 10 ),
				),
			...
			'Fifth' => array(
				...
				'Distance Distortion' => array( 'page' => 'PH 81', 'type' => 'Alteration', 'cast' => '6 segments',
					'range'    => sprintf( '%u feet', $level * 10 ),
					'duration' => sprintf( '%u turns', $level ),
					'aoe'      => sprintf( '%u square feet', $level * 1000 ),
				),
				...
				'Stone Shape' => array(
					...
					'range'    => 'Touch',
					'duration' => 'Permanent',
					'aoe'      => sprintf( '%u cubic feet', $level ),
					'comps'    => 'V, S, M',
					'cast'     => '1 round',
					'saving'   => 'None',
				),
			...
			'Sixth' => array(
				...
				'Chain Lightning' => array( 'page' => 'UA 59', 'type' => 'Evocation', 'cast' => '6 segments',
					'range'    => sprintf( '%u feet', ( $level * 5 ) + 40 ),
					'special'  => sprintf( 'Initial target damage: %ud6', $level ),
				),
