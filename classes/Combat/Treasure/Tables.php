...
#			array( 'chance' =>  1, 'text' => 'Ollamh Harp (B)',           'xp' => 5000, 'gp' => 25000, 'restrict' => 'B', 'link' => 'DMG 147-148' ),
	...
	protected function get_swords_table() {
		$table = $this->get_base_swords_table();
		$type  = $this->generate_random_result( $this->get_swords_type_table() );
		foreach( $table as $key => $item ) {
			if ( ! is_array( $item ) ) continue;
			$table[ $key ]['text'] = str_replace( '<type>', $type['text'], $item['text'] );
		}
		return $table;
	}

	protected function get_base_swords_table() {
		return array(
			'title' => 'Swords',
			array( 'chance' =>  1, 'text' => 'Sword,<type>, Sun Blade', 'bonus' => 2, 'xp' => 3000, 'gp' => 20000, 'restrict' => ':Good', 'link' => 'https://www.d20pfsrd.com/magic-items/magic-weapons/specific-magic-weapons/sun-blade/' ),
			array( 'chance' =>  7, 'text' => 'Sword,<type>, +1, +2 vs. magic-using & enchanted creatures', 'bonus' => 1, 'xp' => 600, 'gp' => 3000, 'link' => 'DMG 164' ),
			array( 'chance' =>  7, 'text' => 'Sword,<type>, +1, +3 vs. lycanthropes & shape-changers',     'bonus' => 1, 'xp' => 700, 'gp' => 3500, 'link' => 'DMG 164' ),
			array( 'chance' =>  7, 'text' => 'Sword,<type>, +1, +3 vs. regenerating creatures',            'bonus' => 1, 'xp' => 800, 'gp' => 4000, 'link' => 'DMG 164' ),
			array( 'chance' =>  7, 'text' => 'Sword,<type>, +1, +4 vs. reptiles',    'bonus' => 1, 'xp' =>   800, 'gp' =>  4000, 'link' => 'DMG 164' ),
			array( 'chance' =>  7, 'text' => 'Sword,<type>, +1, Cursed',             'bonus' => 1, 'xp' =>  '~~', 'gp' =>  1000, 'link' => 'DMG 165' ),
			array( 'chance' =>  5, 'text' => 'Sword,<type>, +1, Flame Tongue',       'bonus' => 1, 'xp' =>   900, 'gp' =>  4500, 'link' => 'DMG 164' ),
			array( 'chance' =>  1, 'text' => 'Sword,<type>, +1, Luck Blade',         'bonus' => 1, 'xp' =>  1000, 'gp' =>  5000, 'link' => 'DMG 164' ),
			array( 'chance' =>  5, 'text' => 'Sword,<type>, +2, Dragon Slayer',      'bonus' => 2, 'xp' =>   900, 'gp' =>  4500, 'link' => 'DMG 164' ),
			array( 'chance' =>  5, 'text' => 'Sword,<type>, +2, Giant Slayer',       'bonus' => 2, 'xp' =>   900, 'gp' =>  4500, 'link' => 'DMG 164' ),
			array( 'chance' =>  1, 'text' => 'Sword,<type>, +2, Nine Lives Stealer', 'bonus' => 2, 'xp' =>  1600, 'gp' =>  8000, 'link' => 'DMG 164' ),
			array( 'chance' =>  4, 'text' => 'Sword,<type>, +3, Frost Brand',        'bonus' => 3, 'xp' =>  1600, 'gp' =>  8000, 'link' => 'DMG 164' ),
			array( 'chance' =>  2, 'text' => 'Sword,<type>, +4, Defender',           'bonus' => 4, 'xp' =>  3000, 'gp' => 15000, 'link' => 'DMG 164' ),
			array( 'chance' =>  1, 'text' => 'Sword,<type>, +5, Defender',           'bonus' => 5, 'xp' =>  3600, 'gp' => 18000, 'link' => 'DMG 164' ),
			array( 'chance' =>  1, 'text' => 'Sword,<type>, +5, Holy Avenger (LG)',  'bonus' => 5, 'xp' =>  4000, 'gp' => 20000, 'restrict' => ':Lawful Good', 'link' => 'DMG 164' ),
			array( 'chance' =>  8, 'text' => 'Sword,<type>, -2, Cursed',             'bonus' =>-2, 'xp' =>  '~~', 'gp' =>   500, 'link' => 'DMG 165' ),
			array( 'chance' =>  1, 'text' => 'Sword,<type>, Dancing',                'bonus' => 1, 'xp' =>  4400, 'gp' => 22000, 'link' => 'DMG 164-165' ),
			array( 'chance' =>  1, 'text' => 'Sword,<type>, Life Stealing',          'bonus' => 2, 'xp' =>  5000, 'gp' => 25000, 'link' => 'DMG 164' ),
			array( 'chance' =>  2, 'text' => 'Sword,<type>, Sharpness (C)',          'bonus' => 1, 'xp' =>  7000, 'gp' => 35000, 'restrict' => ':Chaotic', 'link' => 'DMG 164' ),
			array( 'chance' => 14, 'text' => 'Sword,<type>, Planes',                 'bonus' => 2, 'xp' =>  2000, 'gp' => 30000, 'link' => 'https://www.d20pfsrd.com/magic-items/magic-weapons/specific-magic-weapons/sword-of-the-planes/' ),
			array( 'chance' =>  1, 'text' => 'Sword,<type>, Wounding',               'bonus' => 1, 'xp' =>  4000, 'gp' => 22000, 'link' => 'DMG 165' ),
			array( 'chance' =>  6, 'text' => 'Sword,<type>, Cursed Berserking',      'bonus' => 2, 'xp' =>  '~~', 'gp' =>   500, 'link' => 'DMG 165' ),
			array( 'chance' =>  5, 'text' => 'Sword,Short, Quickness (+2)',          'bonus' => 2, 'xp' =>  1000, 'gp' => 17500, 'link' => '' ),
			array( 'chance' =>  1, 'text' => 'Sword,<type>, Vorpal Weapon (L)',      'bonus' => 3, 'xp' => 10000, 'gp' => 50000, 'restrict' => ':Lawful', 'link' => 'DMG 165' ),
	...
	protected function get_weapons_table() {
		return array(
			...
			array( 'chance' => 60, 'text' => 'Arrow**, 2d12 in number',  'bonus' =>  0, 'xp' =>   20, 'gp' =>   120, 'ex' => 'N:2', 'link' => 'DMG' ),
			array( 'chance' => 30, 'text' => 'Arrow**, 2d8 in number',   'bonus' =>  0, 'xp' =>   20, 'gp' =>   120, 'ex' => 'N:2', 'link' => 'DMG' ),
			array( 'chance' => 15, 'text' => 'Arrow**, 2d6 in number',   'bonus' =>  0, 'xp' =>   20, 'gp' =>   120, 'ex' => 'N:2', 'link' => 'DMG' ),
			array( 'chance' =>  5, 'text' => 'Arrow of Direction',       'bonus' =>  0, 'xp' => 2500, 'gp' => 17500, 'ex' => 'N:0', 'link' => '' ),
			array( 'chance' =>  3, 'text' => 'Arrow of Slaying',         'bonus' =>  3, 'xp' =>  250, 'gp' =>  2500, 'ex' => 'N:0', 'link' => 'DMG 167' ),
			array( 'chance' => 60, 'text' => 'Axe*',                     'bonus' =>  0, 'xp' =>  300, 'gp' =>  1750, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' =>  5, 'text' => 'Axe +2, Throwing',         'bonus' =>  2, 'xp' =>  750, 'gp' =>  4500, 'ex' => 'Y:0', 'link' => 'DMG 167' ),
			array( 'chance' =>  5, 'text' => 'Axe of Hurling*',          'bonus' =>  0, 'xp' => 1500, 'gp' => 15000, 'ex' => 'Y:1', 'link' => '' ),
			array( 'chance' => 25, 'text' => 'Battle Axe*',              'bonus' =>  0, 'xp' =>  400, 'gp' =>  2500, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' => 60, 'text' => 'Bolt**, 2d10 in number',   'bonus' =>  0, 'xp' =>   50, 'gp' =>   300, 'ex' => 'N:2', 'link' => 'DMG 167' ),
			array( 'chance' => 30, 'text' => 'Bolt**, 2d8 in number',    'bonus' =>  0, 'xp' =>   50, 'gp' =>   300, 'ex' => 'N:2', 'link' => 'DMG 167' ),
			array( 'chance' => 15, 'text' => 'Bolt**, 2d6 in number',    'bonus' =>  0, 'xp' =>   50, 'gp' =>   300, 'ex' => 'N:2', 'link' => 'DMG 167' ),
			array( 'chance' => 25, 'text' => 'Bow*',                     'bonus' =>  0, 'xp' =>  500, 'gp' =>  3500, 'ex' => 'Y:1', 'link' => 'DMG 167' ),
			array( 'chance' => 30, 'text' => 'Bullet, Sling**',          'bonus' =>  0, 'xp' =>   10, 'gp' =>    10, 'ex' => 'N:2', 'link' => '' ),
			array( 'chance' =>  5, 'text' => 'Crossbow of Accuracy, +3', 'bonus' =>  3, 'xp' => 2000, 'gp' => 12000, 'ex' => 'Y:0', 'link' => 'DMG 167' ),
			array( 'chance' =>  5, 'text' => 'Crossbow of Distance',     'bonus' =>  1, 'xp' => 1500, 'gp' =>  7500, 'ex' => 'Y:0', 'link' => 'DMG 167' ),
			array( 'chance' =>  5, 'text' => 'Crossbow of Speed',        'bonus' =>  1, 'xp' => 1500, 'gp' =>  7500, 'ex' => 'Y:0', 'link' => 'DMG 167' ),
			array( 'chance' => 60, 'text' => 'Dagger +1, +2 vs. S',      'bonus' =>  1, 'xp' =>  100, 'gp' =>   750, 'ex' => 'Y:0', 'link' => '' ),
			array( 'chance' => 30, 'text' => 'Dagger +2, +3 vs. L',      'bonus' =>  2, 'xp' =>  250, 'gp' =>  2000, 'ex' => 'Y:0', 'link' => '' ),
			array( 'chance' =>  5, 'text' => 'Dagger +2, Longtooth',     'bonus' =>  2, 'xp' =>  300, 'gp' =>  2500, 'ex' => 'Y:0', 'link' => '' ),
			array( 'chance' =>  5, 'text' => 'Dagger of Throwing*',      'bonus' =>  0, 'xp' =>  250, 'gp' =>  2500, 'ex' => 'Y:1', 'link' => '' ),
			array( 'chance' =>  3, 'text' => 'Dagger of Venom',          'bonus' =>  1, 'xp' =>  350, 'gp' =>  3000, 'ex' => 'Y:0', 'link' => 'DMG 167' ),
			array( 'chance' =>  8, 'text' => 'Dart** (3d4)',             'bonus' =>  0, 'xp' =>   50, 'gp' =>   300, 'ex' => 'N:2', 'link' => 'DMG' ),
			array( 'chance' =>  3, 'text' => 'Dart of Homing',           'bonus' =>  0, 'xp' =>  450, 'gp' =>  4500, 'ex' => 'Y:0', 'link' => '' ),
			array( 'chance' => 40, 'text' => 'Flail*',                   'bonus' =>  0, 'xp' =>  450, 'gp' =>  4000, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' => 25, 'text' => 'Hammer*',                  'bonus' =>  0, 'xp' =>  300, 'gp' =>  2500, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' =>  5, 'text' => 'Hammer +3, Dwarven Thrower', 'bonus' =>  2, 'xp' =>1500,'gp' => 15000, 'ex' => 'Y:0', 'link' => 'DMG 167' ),
			array( 'chance' =>  2, 'text' => 'Hammer of Thunderbolts',   'bonus' =>  3, 'xp' => 2500, 'gp' => 25000, 'ex' => 'Y:0', 'link' => 'DMG 167-168' ),
			array( 'chance' =>  5, 'text' => 'Hornblade*',               'bonus' =>  0, 'xp' =>  500, 'gp' =>  5000, 'ex' => 'Y:1', 'link' => 'http://www.mountnevermind.de/Dokumente/DMG/DD01099.htm' ),
			array( 'chance' => 25, 'text' => 'Javelin*',                 'bonus' =>  0, 'xp' =>  375, 'gp' =>  2500, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' =>  5, 'text' => 'Javelin of Lightning',     'bonus' =>  0, 'xp' =>  250, 'gp' =>  3000, 'ex' => 'Y:0', 'link' => '' ),
			array( 'chance' =>  5, 'text' => 'Javelin of Piercing',      'bonus' =>  0, 'xp' =>  250, 'gp' =>  3000, 'ex' => 'Y:0', 'link' => '' ),
			array( 'chance' => 40, 'text' => 'Knife*',                   'bonus' =>  0, 'xp' =>  100, 'gp' =>   750, 'ex' => 'Y:1', 'link' => '' ),
			array( 'chance' => 25, 'text' => 'Knife, Buckle*',           'bonus' =>  0, 'xp' =>  100, 'gp' =>  1000, 'ex' => 'Y:1', 'link' => '' ),
			array( 'chance' => 25, 'text' => 'Lance*',                   'bonus' =>  0, 'xp' =>    0, 'gp' =>     0, 'ex' => 'Y:1', 'link' => '' ),
			array( 'chance' =>  5, 'text' => 'Net of Entrapment',        'bonus' =>  0, 'xp' => 1000, 'gp' =>  7500, 'ex' => 'Y:0', 'link' => '' ),
			array( 'chance' =>  5, 'text' => 'Net of Snaring',           'bonus' =>  0, 'xp' => 1000, 'gp' =>  6000, 'ex' => 'Y:0', 'link' => '' ),
			array( 'chance' => 30, 'text' => 'Mace*',                    'bonus' =>  0, 'xp' =>  350, 'gp' =>  3000, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' =>  5, 'text' => 'Mace of Disruption',       'bonus' =>  1, 'xp' => 1750, 'gp' => 17500, 'ex' => 'Y:0', 'link' => 'DMG 168' ),
			array( 'chance' => 25, 'text' => 'Military Pick*',           'bonus' =>  0, 'xp' =>  350, 'gp' =>  2500, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' => 25, 'text' => 'Morning Star*',            'bonus' =>  0, 'xp' =>  400, 'gp' =>  3000, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' =>  8, 'text' => 'Pole Arm*',                'bonus' =>  0, 'xp' =>    0, 'gp' =>     0, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' => 25, 'text' => 'Quarterstaff*',            'bonus' =>  0, 'xp' =>  250, 'gp' =>  1500, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' => 25, 'text' => 'Scimitar*',                'bonus' =>  0, 'xp' =>  375, 'gp' =>  3000, 'ex' => 'Y:1', 'link' => 'DMG 168' ),
			array( 'chance' =>  5, 'text' => 'Scimitar of Speed*',       'bonus' =>  0, 'xp' => 2500, 'gp' =>  9000, 'ex' => 'Y:1', 'link' => '' ),
			array( 'chance' =>  5, 'text' => 'Sling of Seeking +2',      'bonus' =>  2, 'xp' =>  700, 'gp' =>  7000, 'ex' => 'Y:0', 'link' => 'DMG 168' ),
			array( 'chance' => 50, 'text' => 'Spear*',                   'bonus' =>  0, 'xp' =>  500, 'gp' =>  3000, 'ex' => 'Y:1', 'link' => 'DMG 168' ),
			array( 'chance' => 15, 'text' => 'Spear, Cursed Backbiter',  'bonus' =>  1, 'xp' =>    0, 'gp' =>  1000, 'ex' => 'N:0', 'link' => 'DMG 168' ),
			array( 'chance' => 34, 'text' => 'Sword,Long*',              'bonus' =>  0, 'xp' =>  500, 'gp' =>  2500, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' => 10, 'text' => 'Sword,Broad*',             'bonus' =>  0, 'xp' =>  350, 'gp' =>  1600, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' =>  3, 'text' => 'Sword,Short*',             'bonus' =>  0, 'xp' =>  250, 'gp' =>  1250, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' =>  2, 'text' => 'Sword,Bastard*',           'bonus' =>  0, 'xp' =>  850, 'gp' =>  4100, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' =>  1, 'text' => 'Sword,Two-Handed*',        'bonus' =>  0, 'xp' => 1000, 'gp' =>  5000, 'ex' => 'Y:1', 'link' => 'DMG' ),
			array( 'chance' =>  5, 'text' => 'Trident (Military Fork)*', 'bonus' =>  0, 'xp' => 1500, 'gp' => 12500, 'ex' => 'Y:1', 'link' => 'DMG 168' ),
			array( 'chance' =>  5, 'text' => 'Trident of Fish Command',  'bonus' =>  1, 'xp' =>  500, 'gp' =>  4000, 'ex' => 'Y:0', 'link' => 'DMG 155' ),
			array( 'chance' =>  4, 'text' => 'Trident of Submission',    'bonus' =>  1, 'xp' => 1500, 'gp' => 12500, 'ex' => 'Y:0', 'link' => 'DMG 155' ),
			array( 'chance' =>  5, 'text' => 'Trident of Warning',       'bonus' =>  2, 'xp' => 1000, 'gp' => 10000, 'ex' => 'Y:0', 'link' => 'DMG 155' ),
			array( 'chance' =>  4, 'text' => 'Trident of Yearning',      'bonus' => -2, 'xp' =>    0, 'gp' =>  1000, 'ex' => 'N:0', 'link' => 'DMG 155' ),
